...
git reset --mixed <HEAD_id> # 从仓库指定id恢复仓库和暂存区
git checkout -- <file_name> # 舍弃工作区的更改
...
git reset --hard <HEAD_id>  # 从仓库指定id恢复仓库,暂存区和工作区
```
